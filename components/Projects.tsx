    ...
    <div id='projects' className='w-full'>
      <div className='max-w-[1240px] mx-auto px-6 py-16'>
        ...
        <p className='group py-2 text-zinc-600'>
            ...
            or <a className="underline underline-offset-2 decoration-2 decoration-sky-700 hover:decoration-[3px] hover:decoration-sky-800" href="https://github.com/julialding/">Github</a>.<span> </span>
          </p>
      </div>
    </div>
  );
