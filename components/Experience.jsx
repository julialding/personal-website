      ...
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='group py-2 text-zinc-600'>
            ...
            or <a class="underline underline-offset-2 decoration-2 decoration-sky-700 hover:decoration-[3px] hover:decoration-sky-800" href="https://github.com/julialding/">Github</a>.<span> </span>Relevant courses include:
          </p>
          <ul className='pl-4'>
